...
function module.options:Load()
	...
	self.updateRoster = ELib:Button(self,L.RaidGroupsCurrentRoster):Size(ExRT.isClassic and 315 or 155,20):Point("TOPLEFT",10,-565):OnClick(function()
	...
	self.splitRoster = ELib:Button(self,L.RaidGroupsSplitRoster):Size(135,20):Point("LEFT",self.updateRoster,"RIGHT",5,0):Shown(false):OnClick(function()
		module.options:SplitRoster()
	end)

	self.splitRosterOptions = ELib:DropDownButton(self,"|TInterface\\AddOns\\"..GlobalAddonName.."\\media\\DiesalGUIcons16x256x128:14:14:0:0:256:128:16:32:64:80|t",200,-1):Size(20,20):Point("LEFT",self.splitRoster,"RIGHT",0,0):Shown(false)
	do
		local gfs = {}
