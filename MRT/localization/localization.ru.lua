...
L.raidcheckflaskchatTooltip = "Кнопку может нажать любой игрок, но опубликовать результат в чат сможет только лидер или помощник рейда."
L.raidcheckslak = "Публиковать слакеров в чат во время проверки готовности"
L.raidcheckslakTooltip = "Только лидер может писать отчёт в чат."
...
L.cd2ColSetIconWidth = "Ширина иконки"
L.cd2ColSetIconHeight = "Высота иконки"
L.cd2ColSetSeparateIconHW = "Раздельная высота и ширина"
L.cd2ColSetSeparateIconHWTooltip = "Использовать независимые ширину и высоту для иконок.|nРаботает только в icon-шаблонах (с анимацией восстановления на иконке)."

L.cd2ATFLockTooltip = "Недоступно при включённом «Attach to Frames»."
L.cd2ExtIconFontLockTooltip = "Недоступно при включённых «Расширенных настройках шрифта иконки»."

L.cd2ColSetTextIconFontMode = "Расширенные настройки шрифта иконки"
L.cd2ColSetTextIconFontTop = "Icon Верх"
L.cd2ColSetTextIconFontCenter = "Icon Центр"
L.cd2ColSetTextIconFontBottom = "Icon Низ"
L.cd2ColSetTextIconCrop = "Обрезать имя/цель"
L.cd2OffsetX = "Отступ X"
L.cd2OffsetY = "Отступ Y"
L.cd2ColSetIconAnchor = "Якорь"
...
L.cd2GlowColor = "Цвет свечения"
L.cd2GlowColorTooltip = "Цвет эффекта свечения (только для типов 1, 2, 3)"
L.cd2ColSetIconPosition = "Позиция"
L.cd2ColSetIconGrowth = "Рост"
...
L.BossWatcherSaveVariablesSaved = "Сохранено"
...
L.BossWatcherTrackingEmptyHint = "В этом бою не было ни одного отслеживаемого спелла.\nВкладка Tracking заполняется только когда дебафф энкаунтера из\nподвкладки Settings реально вешается на члена рейда в бою.\nНа обычных и элитных мобах вне рейда список останется пустым —\nэто поведение by design, не баг."
L.BossWatcherDamageTakenEmptyHint = "В этом бою ещё нет данных о полученном уроне.\nГрафик собирает урон, который члены рейда получили в бою,\nс разделением tank/non-tank (или absorbed / enemy через радио).\nВ соло-боях против обычных и элитных мобов график может остаться\nпустым, если игрок не получил отслеживаемого урона."
...
L.LoggingHelp1 = "Лог будет сохраняться в файл 'Logs\\WoWCombatLog.txt' в папке с игрой. В последующем его можно загрузить на специальные сайты для анализа (например WoW-Logs.co.in). Не забывайте загружать и/или удалять его после каждого рейда."
...
L.AttendanceSortByAny = "Любая группа"
L.AttendanceSortByAnyTooltip = "Сортировать таблицу по количеству посещений в любой рейд-группе (колонки 2 и 3)."
L.AttendanceSortByMain = "Основной рейд"
L.AttendanceSortByMainTooltip = "Сортировать таблицу по количеству посещений в основных группах рейда (колонки 4 и 5)."
...
L.ReminderDD = "Урон"
L.ReminderRDD = "Дальний урон"
L.ReminderMDD = "Ближний урон"
L.ReminderRHEALER = "Дальние хилы"
L.ReminderMHEALER = "Ближние хилы"
...
L.ReminderTabPersonal = "Персональные настройки"
...
L.ReminderDisableChat = "Заглушить чат"
L.ReminderDisableChatTooltip = "Подавить все ремайндеры с выводом в чат (SAY/YELL/PARTY/RAID).\nПолезно, если импортированный профиль автоматически шлёт в группу события вроде DRINKING/SPEC DETECTED/TRINKET USED/INTERRUPTED/RESURRECTING и спамит."
