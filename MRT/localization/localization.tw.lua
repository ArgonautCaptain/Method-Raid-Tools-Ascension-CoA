...
L.raidcheckflaskchatTooltip = "任何人都可以點擊此按鈕，但只有團隊隊長或副隊長才能將結果發送至聊天頻道。"
L.raidcheckslak = "在團隊確認時檢查食物及藥劑"
L.raidcheckslakTooltip = "必須是隊長才能在聊天中報告。"
...
L.cd2ColSetIconWidth = "圖示寬度"
L.cd2ColSetIconHeight = "圖示高度"
L.cd2ColSetSeparateIconHW = "寬高分離"
L.cd2ColSetSeparateIconHWTooltip = "對圖示使用獨立的寬度和高度。|n僅適用於圖示樣板（啟用了圖示冷卻動畫的樣板）。"

L.cd2ATFLockTooltip = "啟用「Attach to Frames」時不可用。"
L.cd2ExtIconFontLockTooltip = "啟用「進階圖示字體設定」時不可用。"

L.cd2ColSetTextIconFontMode = "進階圖示字體設定"
L.cd2ColSetTextIconFontTop = "Icon 上"
L.cd2ColSetTextIconFontCenter = "Icon 中"
L.cd2ColSetTextIconFontBottom = "Icon 下"
L.cd2ColSetTextIconCrop = "裁切 名稱/目標"
L.cd2OffsetX = "水平偏移"
L.cd2OffsetY = "垂直偏移"
L.cd2ColSetIconAnchor = "錨點"
