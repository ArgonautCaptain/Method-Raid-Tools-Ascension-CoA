...
if not GetItemInfoInstant then
	GetItemInfoInstant = function(item)
		...
		local name, link, quality, ilvl, req, class, subclass, maxstack, equipLoc, texture = GetItemInfo(itemID or item)
		return itemID or 0, nil, nil, nil, texture, class, subclass
	end
end

if not _G.LANDING_PAGE_REPORT then _G.LANDING_PAGE_REPORT = (ExRT and ExRT.L and ExRT.L.General) or "General" end
...
local _FDID_TO_PATH = {
	[136000] = "Interface\\Icons\\INV_Misc_Food_15",
	[136051] = "Interface\\Icons\\Spell_Nature_Sleep",
	[136210] = "Interface\\Icons\\Spell_Shadow_SoulGem",
	[134062] = "Interface\\Icons\\INV_Misc_Food_62",
	[538745] = "Interface\\Icons\\INV_Stone_04",
	[538744] = "Interface\\Icons\\INV_Stone_04",
	[463543] = "Interface\\Icons\\Trade_Alchemy_PotionC4",
	[3566840] = "Interface\\Icons\\Trade_Alchemy_PotionC4",
	[3528447] = "Interface\\Icons\\INV_Misc_EngGizmos_30",
	[4622275] = "Interface\\Icons\\Trade_Alchemy_PotionC4",
	[134943] = "Interface\\Icons\\INV_Scroll_03",
	[132281] = "Interface\\Icons\\INV_Misc_EngGizmos_17",
	[132333] = "Interface\\Icons\\INV_Alchemy_ElixirOfFortitude",
	[135932] = "Interface\\Icons\\Spell_Arcane_Blast",
	[135987] = "Interface\\Icons\\INV_Potion_51",
	[136078] = "Interface\\Icons\\INV_Misc_Rune_01",
}
local function _SetTextureCompat(tex, arg1, ...)
	if type(arg1) == "number" and _FDID_TO_PATH[arg1] then
		return tex:SetTexture(_FDID_TO_PATH[arg1], ...)
	end
	return tex:SetTexture(arg1, ...)
end

local function _RemapFDIDArray(arr)
	if type(arr) ~= "table" then return end
	for i, v in pairs(arr) do
		if type(v) == "number" and _FDID_TO_PATH[v] then
			arr[i] = _FDID_TO_PATH[v]
		end
	end
end
...
module.db.tableFood = {
	...
	[146808]=true,	[146807]=true,	[146806]=true,	[146805]=true,	[146804]=true,	[146809]=true,
...
module.db.foodWellFedReferenceIds = {25661, 33256, 57288, 65410}

module.db.tableFood_headers = {0,375}
...
module.db.tableFlask_headers = {0,1}
module.db.tablePotion = ExRT.isWotLKOnly and {
	[53762] = true,
	[53909] = true,
	[53908] = true,
	[53910] = true,
...
module.db.coaBuffs = {
...

	{
		...
		spells = {
			...
			[523495] = true, -- Greater Man'ari Intuition — Felsworn - Class Buff
...
if ExRT.isLK then
	module.db.classicBuffs = {
		...
		{"armor","Armor",135926,{[588]=1,[7128]=2,[602]=3,[1006]=4,[10951]=5,[10952]=6,[25431]=7,[48040]=8,[48168]=9}},
		{"shadow","Shadow",136121,{[48170]=5,[25433]=4,[10958]=3,[976]=1,[10957]=2,[27683]=3,[39374]=4,[48169]=5}},
		{"stamina","Stamina",135987,{[1243]=1,[21562]=5,[21564]=6,[25392]=7,[48162]=8,[1244]=2,[1245]=3,[2791]=4,[10937]=5,[10938]=6,[25389]=7,[48161]=8}},
	}
elseif ExRT.isBC then
	module.db.classicBuffs = {
		...
		{"armor","Armor",135926,{[588]=1,[7128]=2,[602]=3,[1006]=4,[10951]=5,[10952]=6,[25431]=7,}},
		{"shadow","Shadow",136121,{[25433]=4,[10958]=3,[976]=1,[10957]=2,[27683]=3,[39374]=4,}},
		{"stamina","Stamina",135987,{[1243]=1,[21562]=5,[21564]=6,[25392]=7,[1244]=2,[1245]=3,[2791]=4,[10937]=5,[10938]=6,[25389]=7,}},
	}
else
	module.db.classicBuffs = {
		...
		{"armor","Armor",135926,{[588]=1,[7128]=2,[602]=3,[1006]=4,[10951]=5,[10952]=6,}},
		{"shadow","Shadow",136121,{[10958]=3,[976]=1,[10957]=2,[27683]=3,}},
		{"stamina","Stamina",135987,{[1243]=1,[21562]=5,[21564]=6,[1244]=2,[1245]=3,[2791]=4,[10937]=5,[10938]=6,}},
	}
end
if ExRT.isLK then
	module.db.classicBuffs[#module.db.classicBuffs+1] = {"bom","BoM",135908,{[19740]=1,[19834]=2,[19835]=3,[19836]=4,[19837]=5,[19838]=6,[25291]=7,[27140]=8,[48931]=9,[48932]=10,[25782]=6,[25916]=7,[27141]=8,[48933]=9,[48934]=10}}
	module.db.classicBuffs[#module.db.classicBuffs+1] = {"bow","BoW",135970,{[19742]=1,[19850]=2,[19852]=3,[19853]=4,[19854]=5,[25290]=6,[27142]=7,[48935]=8,[48936]=9,[25894]=5,[25918]=6,[27143]=7,[48937]=8,[48938]=9}}
	module.db.classicBuffs[#module.db.classicBuffs+1] = {"bok","BoK",135993,{[20217]=1,[25898]=1,[69378]=1}}
	module.db.classicBuffs[#module.db.classicBuffs+1] = {"bos","BoS",135911,{[25899]=1,[20911]=1}}
elseif ExRT.isBC then
	module.db.classicBuffs[#module.db.classicBuffs+1] = {"bom","BoM",135908,{[19740]=1,[19834]=2,[19835]=3,[19836]=4,[19837]=5,[19838]=6,[25291]=7,[27140]=8,[25782]=6,[25916]=7,[27141]=8}}
	module.db.classicBuffs[#module.db.classicBuffs+1] = {"bow","BoW",135970,{[19742]=1,[19850]=2,[19852]=3,[19853]=4,[19854]=5,[25290]=6,[27142]=7,[25894]=5,[25918]=6,[27143]=7,}}
	module.db.classicBuffs[#module.db.classicBuffs+1] = {"bok","BoK",135993,{[20217]=1,[25898]=1,}}
	module.db.classicBuffs[#module.db.classicBuffs+1] = {"bos","BoS",135967,{[1038]=1,[25895]=1,}}
elseif ExRT.isClassic and UnitFactionGroup("player") == "Alliance" then
	module.db.classicBuffs[#module.db.classicBuffs+1] = {"bom","BoM",135908,{[19740]=1,[19834]=2,[19835]=3,[19836]=4,[19837]=5,[19838]=6,[25291]=7,[25782]=6,[25916]=7,}}
	module.db.classicBuffs[#module.db.classicBuffs+1] = {"bow","BoW",135970,{[19742]=1,[19850]=2,[19852]=3,[19853]=4,[19854]=5,[25290]=6,[25894]=5,[25918]=6,}}
	module.db.classicBuffs[#module.db.classicBuffs+1] = {"bok","BoK",135993,{[20217]=1,[25898]=1,}}
	module.db.classicBuffs[#module.db.classicBuffs+1] = {"bos","BoS",135967,{[1038]=1,[25895]=1,}}
end
...
if ExRT.isClassic then
	...
	local function RCW_GetBuffIconFromRanks(ranks)
		...
		for spellID, rank in pairs(ranks) do
			if type(spellID) == "number" and type(rank) == "number" then
				sorted[#sorted+1] = {spellID, rank}
			end
		end
		table.sort(sorted, function(a,b) return a[2] > b[2] end)
		local _Tex = (ExRT.F and ExRT.F.GetSpellTextureSafe) or GetSpellTexture
		for i=1,#sorted do
			local sid = sorted[i][1]
			local tex = _Tex(sid)
			if tex and tex ~= "Interface\\Icons\\INV_Misc_QuestionMark" then return tex end
		end
		return "Interface\\Icons\\INV_Misc_QuestionMark"
	end

	for i=1,#module.db.classicBuffs do
		if type(module.db.classicBuffs[i][3]) == "number" then
			module.db.classicBuffs[i][3] = RCW_GetBuffIconFromRanks(module.db.classicBuffs[i][4])
		end
	end
end
...
module.db.tableRunes = ExRT.isWotLKOnly and {
	[72590] = 80,
	[73422] = 80,
} or {[224001]=5,[270058]=6,[317065]=6,[347901]=18,[367405]=18,[393438]=87,[453250]=87,[1234969]=733,[1242347]=733}
...
local function GetFood(checkType)
	if not module.db.wellFedLocalizedName then
		for i=1,#module.db.foodWellFedReferenceIds do
			local n = GetSpellInfo(module.db.foodWellFedReferenceIds[i])
			if n and n ~= "" then
				module.db.wellFedLocalizedName = n
				break
			end
		end
	end
	local wellFedName = module.db.wellFedLocalizedName
		...
		if name and subgroup <= gMax then
			...
			for i=1,40 do
				...
				if not auraData then
					...
					if foodType
						or auraData.icon == 136000 or auraData.icon == 132805 or auraData.icon == 133950
						or (wellFedName and auraData.name == wellFedName)
					then
...
do
	...
	function module:DurabilityCheckRaw()
		local totalCurrent, totalMax, broken = 0, 0, 0
		for _,v in pairs(charItemSlotsTable) do
			...
			if current and maximum then
				...
				if current == 0 and maximum > 0 then
					broken = broken + 1
				end
			end
		end
		return totalCurrent, totalMax, broken
	end
	function module:DurabilityCheck()
		local totalCurrent, totalMax = module:DurabilityCheckRaw()
		if totalMax == 0 then
			return 100
		else
...
local function RCW_AddIcon(parent,texture)
	...
	icon.text = icon:CreateFontString(nil,"OVERLAY","ExRTFontNormal")
	icon.text:SetPoint("BOTTOMRIGHT",4,0)
	icon.text:SetJustifyH("RIGHT")
	icon.text:SetTextColor(0,1,0,1)
	local __fontPath = icon.text:GetFont()
	if not __fontPath or __fontPath == "" then
		__fontPath = STANDARD_TEXT_FONT
	end
	icon.text:SetFont(__fontPath,8,"")
	...
	icon.bigText:SetFont(__fontPath,10,"")
...
do
	...
	local cR1,cG1,cB1 = 1,.2,.2
	local cR3,cG3,cB3 = .6,.6,.2
	local cR2,cG2,cB2 = .2,.7,.2
...
do
	...
	local function abbreviateHeader(text)
		if not text or text == "" then return text end
		local exact = HEADER_ABBREV[text]
		if exact then return exact end
		local lower = text:lower()
		if lower:find("durab") then return "Dur" end
		if lower:find("stamin") then return "Stam" end
		if lower:find("armor") then return "Arm" end
		if lower:find("item ?l") then return "ILvL" end
		if lower:find("shadow") then return "Shd" end
		if lower:find("scroll") then return "Scr" end
		return text
	end
	...
	local function hideHeaderTooltip()
		GameTooltip:Hide()
	end
	...
	local function hookHeader(h)
		if not h or h.__diagonalHooked then return end
		h.__diagonalHooked = true
	...
	headers.applyDiagonal = function(_, h) applyHeaderDiagonal(h) end
	headers.hookHeader     = function(_, h) hookHeader(h) end

	for i = 1, #RCW_iconsListHeaders do
		local h = headers[i]
		if h then
			hookHeader(h)
			applyHeaderDiagonal(h)
		end
	end
end
...
function module.frame:UpdateRoster()
	...
	for i=1,(self.isTest and (ExRT.isClassic and 40 or math.random(0,1)*10+20) or 40) do
		...
		if self.isTest then
			...
			subgroup = i / 5
			class = ExRT.GDB.ClassList[math.random(1, #ExRT.GDB.ClassList)]
			unit = "raid"..i
		...
		if line.unit then
			...
			if not onlyLine or line == onlyLine then
				...
				for i,key in pairs(RCW_iconsList) do
					...
					if line[key].cd then line[key].cd:Hide() end
					line[key]:Point("CENTER",line[key.."pointer"],"CENTER",0,0)
					...
					for j=2,4 do
						...
						if line[key..j].cd then line[key..j].cd:Hide() end
					end
				end
				for i=1,60 do
				...
				if line.kit and not self.isTest then
					...
					if kNow == "1" then
						...
						_SetTextureCompat(line.kit.texture, 3528447)
...
local _bw_ext_dur_resp_antispam = 0

local function _ExtDurabilityStore(sender, percent, broken)
	if not sender or not percent then return end
	...
	local line = RCW_UnitToLine[shortName]
	if line and module.frame and module.frame:IsShown() then
		module.frame:UpdateData(line)
	end
end


local INSPECT_DUR_SLOTS = {1,3,5,6,7,8,9,10,15,16,17,18}

local _rcDurTip = CreateFrame("GameTooltip", "MRTRCDurScantip", nil, "GameTooltipTemplate")
_rcDurTip:SetOwner(WorldFrame, "ANCHOR_NONE")

local _DUR_PATTERN = (DURABILITY_TEMPLATE or "Durability %d / %d"):gsub("%%d", "(%%d+)")

local function _ScanUnitDurability(unit)
	if not unit or not UnitName(unit) then return end
	local cur, mx, broken = 0, 0, 0
	for _, slot in ipairs(INSPECT_DUR_SLOTS) do
		_rcDurTip:ClearLines()
		_rcDurTip:SetInventoryItem(unit, slot)
		for line=1, _rcDurTip:NumLines() do
			local fs = _G["MRTRCDurScantipTextLeft"..line]
			local txt = fs and fs:GetText()
			if txt then
				local c, m = txt:match(_DUR_PATTERN)
				if c and m then
	...
	if mx > 0 then
		...
		_ExtDurabilityStore(name, math.floor(cur / mx * 100), broken)
	end
end

local _inspectQueue = {}
local _inspectInflight = nil
local _inspectInflightGUID = nil
local _inspectLastFire = 0
local INSPECT_THROTTLE = 2.0
local INSPECT_TIMEOUT = 5.0

local _StepInspectQueue
_StepInspectQueue = function()
	...
	if wait > 0 then
		ExRT.F.ScheduleTimer(_StepInspectQueue, wait)
		return
	end
	while #_inspectQueue > 0 do
		local unit = tremove(_inspectQueue, 1)
		if unit and UnitExists(unit) and not UnitIsUnit(unit, "player")
		   and CanInspect and CanInspect(unit, false)
		   and (not CheckInteractDistance or CheckInteractDistance(unit, 1)) then
			_inspectInflight = unit
			_inspectInflightGUID = UnitGUID(unit)
			_inspectLastFire = GetTime()
			if MuteSoundFile and SOUNDKIT and SOUNDKIT.IG_CHARACTER_INFO_OPEN then
				pcall(MuteSoundFile, SOUNDKIT.IG_CHARACTER_INFO_OPEN)
				ExRT.F.ScheduleTimer(function()
					if UnmuteSoundFile then pcall(UnmuteSoundFile, SOUNDKIT.IG_CHARACTER_INFO_OPEN) end
				end, INSPECT_THROTTLE)
			end
			pcall(NotifyInspect, unit)
			ExRT.F.ScheduleTimer(function()
				if _inspectInflight == unit then
					_inspectInflight = nil
					_inspectInflightGUID = nil
					_StepInspectQueue()
				end
			end, INSPECT_TIMEOUT)
			return
...
local _inspReadyFrame = CreateFrame("Frame")
_inspReadyFrame:SetScript("OnEvent", function(_, event, guid)
	if event ~= "INSPECT_READY" or not _inspectInflight then return end
	if guid and _inspectInflightGUID and guid ~= _inspectInflightGUID then return end
	pcall(_ScanUnitDurability, _inspectInflight)
	_inspectInflight = nil
	_inspectInflightGUID = nil
	_StepInspectQueue()
end)
_inspReadyFrame:RegisterEvent("INSPECT_READY")

function module:DurabilityRaidScan()
	if InCombatLockdown() then return end
	do
		local cur, mx, broken = self:DurabilityCheckRaw()
		if mx > 0 then
			local me = (ExRT.SDB and ExRT.SDB.charName) or UnitName("player")
			if me then
				_ExtDurabilityStore(me, math.floor(cur / mx * 100), broken)
			end
		end
	end
	local prefix, total
	if IsInRaid and IsInRaid() then
		prefix = "raid"
		total = (GetNumRaidMembers and GetNumRaidMembers()) or 0
	...
	for i=1,total do
		...
		if UnitExists(unit) and not UnitIsUnit(unit, "player") then
			local already = (_inspectInflight == unit)
			if not already then
				for j=1,#_inspectQueue do
					if _inspectQueue[j] == unit then already = true break end
				end
			end
			if not already then
				_inspectQueue[#_inspectQueue+1] = unit
			end
		end
	end
	_StepInspectQueue()
...
local function _RespondToCTRADurReq(requestby)
	local now = GetTime()
	if now - _bw_ext_dur_resp_antispam < 30 then return end
	_bw_ext_dur_resp_antispam = now

	local cur, max, broken = module:DurabilityCheckRaw()
	if max == 0 then return end

	local channel = (IsInRaid and IsInRaid()) and "RAID" or (GetNumPartyMembers and GetNumPartyMembers() > 0) and "PARTY" or nil
	if not channel then return end

	local SAM = (C_ChatInfo and C_ChatInfo.SendAddonMessage) or SendAddonMessage
	if not SAM then return end
	local payload = string.format("DUR %d %d %d %s", cur, max, broken, requestby or ExRT.SDB.charName or "player")
	pcall(SAM, "CTRA", payload, channel)
end

do
	local RAMP = C_ChatInfo and C_ChatInfo.RegisterAddonMessagePrefix
	if type(RAMP) == "function" then
		pcall(RAMP, "CTRA")
		pcall(RAMP, "oRA3")
	end
end
...
function module:ReadyCheckWindow(starter,isTest,manual)
	...
	if self.frame.hideTimer then
		ExRT.F.CancelTimer(self.frame.hideTimer)
		self.frame.hideTimer = nil
	end
...
function module.main:PLAYER_ENTERING_WORLD()
	if not ExRT.isWotLKOnly or not module.db.classicBuffs then return end
	for i=1,#module.db.classicBuffs do
		local cur = module.db.classicBuffs[i][3]
		if type(cur) == "number" or cur == "Interface\\Icons\\INV_Misc_QuestionMark" then
			local ranks = module.db.classicBuffs[i][4]
			if type(ranks) == "table" then
				local sorted = {}
				for spellID, rank in pairs(ranks) do
					if type(spellID) == "number" and type(rank) == "number" then
...
local function PrepareDataToChat(toSelf)
	if toSelf then
		GetFood(3)
		GetFlask(3)
		if VMRT.RaidCheck.RunesCheck and ExRT.isWotLKOnly then
			GetRunes(3)
		end
...
do
	...
	function module.main:READY_CHECK(starter,timer,isTest)
		...
		if VMRT.RaidCheck.ReadyCheck and not isTest then
...
function module:addonMessage(sender, prefix, type, ver, ...)
	if prefix == "raidcheck" then
		if sender then
			ver = max(tonumber(ver or "0") or 0,3910)
			if type == "DUR" then
				local val = ...
...
addonMsgFrame:SetScript("OnEvent",function (self, event, ...)
	...
	if message and sender and (channel == "RAID" or channel == "PARTY" or channel == "INSTANCE_CHAT") then
		if prefix == "oRA3" and message:find("^SDurability") then
			local min, broken = message:match("^SDurability%^N(%d+)%^N(%d+)")
			if min then
				_ExtDurabilityStore(sender, min, broken)
			end
			return
		elseif prefix == "CTRA" and message:find("^DUR ") then
			local cur, max, broken = message:match("^DUR (%d+) (%d+) (%d+)")
			if cur and max then
				local cn, mn = tonumber(cur), tonumber(max)
				if cn and mn and mn > 0 then
					_ExtDurabilityStore(sender, math.floor(cn / mn * 100), broken)
				end
			end
			return
		elseif prefix == "CTRA" and message == "DURC" then
			_RespondToCTRADurReq(sender)
			return
		end
	end
